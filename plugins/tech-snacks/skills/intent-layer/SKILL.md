...
This skill is vendored from [crafter-station/skills](https://github.com/crafter-station/skills/tree/main/context-engineering/intent-layer) (MIT, © 2026 Crafter Station). See `LICENSE` in this directory.

Built by [Railly Hugo](https://railly.dev) for [Crafter Station](https://crafterstation.com), based on [The Intent Layer](https://www.intent-systems.com/learn/intent-layer) by Tyler Brandt.
